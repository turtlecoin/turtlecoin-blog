  ...
  CountUp = (function () {
    ...
    function e(e, t, r) {
      ...
      (this.target = e),
        ...
        (this.count = function (e) {
          p.startTime || (p.startTime = e);
          var t = e - p.startTime;
          (p.remaining = p.duration - t),
            (p.frameVal = p.useEasing
              ? p.countDown
                ? p.startVal -
                  p.easingFn(t, 0, p.startVal - p.endVal, p.duration)
                : p.easingFn(t, p.startVal, p.endVal - p.startVal, p.duration)
              : p.countDown
              ? p.startVal - (p.startVal - p.endVal) * (t / p.duration)
              : p.startVal + (p.endVal - p.startVal) * (t / p.duration)),
            (p.frameVal = p.countDown
              ? p.frameVal < p.endVal
                ? p.endVal
                : p.frameVal
              : p.frameVal > p.endVal
              ...
              : p.frameVal),
            (p.frameVal =
              Math.round(p.frameVal * p.decimalMult) / p.decimalMult),
            p.printValue(p.frameVal),
            t < p.duration
              ? (p.rAF = requestAnimationFrame(p.count))
              : null === p.finalEndVal
              ? p.callback && p.callback()
              : p.update(p.finalEndVal);
        }),
        (this.formatNumber = function (s) {
          var t,
            ...
            f = 0 > s ? "-" : "";
          if (
            ((t = d(s).toFixed(p.options.decimalPlaces)),
            (m = (u = (t += "").split("."))[0]),
            (c = 1 < u.length ? p.options.decimal + u[1] : ""),
            p.options.useGrouping)
          ) {
            g = "";
            for (var o = 0, b = m.length; o < b; ++o)
              0 != o && 0 == o % 3 && (g = p.options.separator + g),
                (g = m[b - o - 1] + g);
            m = g;
          }
          return (
            p.options.numerals &&
              p.options.numerals.length &&
              ((m = m.replace(/[0-9]/g, function (e) {
                return p.options.numerals[+e];
              })),
              (c = c.replace(/[0-9]/g, function (e) {
                return p.options.numerals[+e];
              }))),
            f + p.options.prefix + m + c + p.options.suffix
          );
        }),
    ...
    return (
      (e.prototype.determineDirectionAndSmartEasing = function () {
        ...
        if (d(t) > this.options.smartEasingThreshold) {
          this.finalEndVal = e;
  ...
  (function (t) {
    ...
    function D(e, t, a) {
      ...
      if (("number" == typeof t && (t = [t]), !Array.isArray(t)))
        throw new Error("noUiSlider (14.2.0): 'range' contains invalid value.");
      if (
        ((s = "min" === e ? 0 : "max" === e ? 100 : parseFloat(e)),
        !p(s) || !p(t[0]))
      )
        throw new Error("noUiSlider (14.2.0): 'range' value isn't numeric.");
      a.xPct.push(s),
        a.xVal.push(t[0]),
        s
    ...
    function O(t) {
      if (e(t)) return !0;
      throw new Error(
        "noUiSlider (14.2.0): 'format' requires 'to' and 'from' methods."
      );
    }
    function j(e, t) {
      if (!p(t)) throw new Error("noUiSlider (14.2.0): 'step' is not numeric.");
      e.singleStep = t;
    }
    function T(e, t) {
      if ("object" != typeof t || Array.isArray(t))
        throw new Error("noUiSlider (14.2.0): 'range' is not an object.");
      if (void 0 === t.min || void 0 === t.max)
        throw new Error(
          "noUiSlider (14.2.0): Missing 'min' or 'max' in 'range'."
        );
      if (t.min === t.max)
        throw new Error(
          "noUiSlider (14.2.0): 'range' 'min' and 'max' cannot be equal."
        );
      e.spectrum = new L(t, e.snap, e.singleStep);
    }
    function H(e, t) {
      if (((t = c(t)), !Array.isArray(t) || !t.length))
        throw new Error("noUiSlider (14.2.0): 'start' option is incorrect.");
      (e.handles = t.length), (e.start = t);
    }
    function z(e, t) {
      if (((e.snap = t), "boolean" != typeof t))
        throw new Error(
          "noUiSlider (14.2.0): 'snap' option must be a boolean."
        );
    }
    function M(e, t) {
      if (((e.animate = t), "boolean" != typeof t))
        throw new Error(
          "noUiSlider (14.2.0): 'animate' option must be a boolean."
        );
    }
    function R(e, t) {
      if (((e.animationDuration = t), "number" != typeof t))
        throw new Error(
          "noUiSlider (14.2.0): 'animationDuration' option must be a number."
        );
    }
    function q(e, t) {
      var a,
      ...
      if (
        ...
        throw new Error(
          "noUiSlider (14.2.0): 'connect' option doesn't match handle count."
        );
      else s = t;
      e.connect = s;
    }
    function B(e, t) {
      switch (t) {
        ...
        default:
          throw new Error(
            "noUiSlider (14.2.0): 'orientation' option is invalid."
          );
      }
    }
    function _(e, t) {
      if (!p(t))
        throw new Error(
          "noUiSlider (14.2.0): 'margin' option must be numeric."
        );
      if (0 !== t && ((e.margin = e.spectrum.getMargin(t)), !e.margin))
        throw new Error(
          "noUiSlider (14.2.0): 'margin' option is only supported on linear sliders."
        );
    }
    function X(e, t) {
      if (!p(t))
        throw new Error("noUiSlider (14.2.0): 'limit' option must be numeric.");
      if (((e.limit = e.spectrum.getMargin(t)), !e.limit || 2 > e.handles))
        throw new Error(
          "noUiSlider (14.2.0): 'limit' option is only supported on linear sliders with 2 or more handles."
        );
    }
    function I(e, t) {
      if (!p(t) && !Array.isArray(t))
        throw new Error(
          "noUiSlider (14.2.0): 'padding' option must be numeric or array of exactly 2 numbers."
        );
      if (Array.isArray(t) && !(2 === t.length || p(t[0]) || p(t[1])))
        throw new Error(
          "noUiSlider (14.2.0): 'padding' option must be numeric or array of exactly 2 numbers."
        );
      if (0 !== t) {
        if (
          ...
          throw new Error(
            "noUiSlider (14.2.0): 'padding' option is only supported on linear sliders."
          );
        if (0 > e.padding[0] || 0 > e.padding[1])
          throw new Error(
            "noUiSlider (14.2.0): 'padding' option must be a positive number(s)."
          );
        if (100 < e.padding[0] + e.padding[1])
          throw new Error(
            "noUiSlider (14.2.0): 'padding' option must not exceed 100% of the range."
          );
      }
    }
    function Y(e, t) {
      switch (t) {
        ...
        default:
          throw new Error(
            "noUiSlider (14.2.0): 'direction' option was not recognized."
          );
      }
    }
    function G(e, t) {
      if ("string" != typeof t)
        throw new Error(
          "noUiSlider (14.2.0): 'behaviour' must be a string containing options."
        );
      ...
      if (r) {
        if (2 !== e.handles)
          throw new Error(
            "noUiSlider (14.2.0): 'fixed' behaviour must be used with 2 handles"
          );
        _(e, e.start[1] - e.start[0]);
      }
      if (o && (e.margin || e.limit))
        throw new Error(
          "noUiSlider (14.2.0): 'unconstrained' behaviour cannot be used with margin or limit"
        );
      e.events = {
        tap: a || n,
        drag: s,
      ...
      if (!1 !== t)
        if (!0 === t) {
          ...
          if (((e.tooltips = c(t)), e.tooltips.length !== e.handles))
            throw new Error(
              "noUiSlider (14.2.0): must pass a formatter for all handles."
            );
          e.tooltips.forEach(function (e) {
            if (
              ...
              throw new Error(
                "noUiSlider (14.2.0): 'tooltips' must be passed a formatter or 'false'."
              );
          });
        }
    }
    ...
    function K(e, t) {
      if (((e.keyboardSupport = t), "boolean" != typeof t))
        throw new Error(
          "noUiSlider (14.2.0): 'keyboardSupport' option must be a boolean."
        );
    }
    function Q(e, t) {
      e.documentElement = t;
    ...
    function Z(e, t) {
      if ("string" != typeof t && !1 !== t)
        throw new Error(
          "noUiSlider (14.2.0): 'cssPrefix' must be a string or `false`."
        );
      e.cssPrefix = t;
    }
    function ee(e, t) {
      if ("object" != typeof t)
        throw new Error("noUiSlider (14.2.0): 'cssClasses' must be an object.");
    ...
    function te(e) {
      ...
      e.format && !e.ariaFormat && (e.ariaFormat = e.format),
        Object.keys(a).forEach(function (r) {
          if (!n(e[r]) && void 0 === s[r]) {
            if (a[r].r)
              throw new Error("noUiSlider (14.2.0): '" + r + "' is required.");
            return !0;
          }
    ...
    function ae(e, n, l) {
      ...
      function g(e, t) {
        var a = p(e, n.cssClasses.origin),
          s = p(a, n.cssClasses.handle);
        return (
          p(s, n.cssClasses.touchArea),
      ...
      function E(e, t) {
        var a = p(t, n.cssClasses.connects);
        (ge = []), (he = []), he.push(x(a, e[0]));
        for (var s = 0; s < n.handles; s++)
          ge.push(g(t, s)), (Ue[s] = s), he.push(x(a, e[s + 1]));
      }
      function N(e) {
      ...
      function D(e, t, a) {
        ...
        if ("count" === e) {
          if (2 > t)
            throw new Error(
              "noUiSlider (14.2.0): 'values' (>= 2) required for mode 'count'."
            );
          var s = t - 1,
            r = 100 / s;
          for (t = []; s--; ) t[s] = s * r;
      ...
      function F(e, a, r) {
        ...
        return (
          ...
          r[0] !== d && (r.unshift(d), (u = !0)),
          r[r.length - 1] !== p && (r.push(p), (m = !0)),
          r.forEach(function (o, d) {
            ...
            if (
              ...
              for (p = t(p, 1e-7), g = E; g <= N; g = n(g, p)) {
                for (
                  f = Ee.toStepping(g),
                    b = f - c,
                    v = b / e,
      ...
      function L(e, t, a) {
        ...
        var d = [n.cssClasses.valueHorizontal, n.cssClasses.valueVertical],
      ...
      function j(e) {
        ...
        var t = e.mode,
          ...
          l = F(a, t, o),
          d = e.format || { to: s };
        return (fe = ye.appendChild(L(l, r, d))), fe;
      }
      function T() {
        ...
        if ((0 === t.type.indexOf("MSPointer") && (o = !0), n)) {
          var l = function (e) {
            return (
              e.target === a ||
              a.contains(e.target) ||
              (e.target.shadowRoot && e.target.shadowRoot.contains(a))
            );
          };
          if ("touchstart" === t.type) {
            var d = Array.prototype.filter.call(t.touches, l);
            if (1 < d.length) return !1;
            (s = d[0].pageX), (r = d[0].pageY);
          } else {
      ...
      function _(e, t) {
        t.handle && (f(t.handle, n.cssClasses.active), (Ae -= 1)),
          t.listeners.forEach(function (e) {
            we.removeEventListener(e[0], e[1]);
          }),
          0 === Ae &&
      ...
      function X(e, t) {
        if (t.handleNumbers.some(A)) return !1;
        var a;
        if (1 === t.handleNumbers.length) {
          var s = ge[t.handleNumbers[0]];
          (a = s.children[0]), (Ae += 1), h(a, n.cssClasses.active);
        }
        e.stopPropagation();
        var r = [],
          o = H(Se.move, we, B, {
        ...
        r.push.apply(r, o.concat(l, d)),
          e.cursor &&
            ((De.style.cursor = getComputedStyle(e.target).cursor),
      ...
      function ie(e, t, a, s) {
        return ((t = Q(Ce, e, t, a, s, !1)), !1 !== t) && (re(e, t), !0);
      }
      function oe(e) {
        if (he[e]) {
          var t = 0,
      ...
      function de(e, t) {
        ...
        for (var r = 1 === Ue.length ? 0 : 1; r < Ue.length; ++r)
          Ue.forEach(function (e) {
            ie(e, Ce[e], !0, !0);
          });
        ne(),
          Ue.forEach(function (e) {
            K("update", e), null !== a[e] && t && K("set", e);
          });
      }
      function pe() {
      ...
      var ce,
        ...
        Pe = {},
        ke = e.ownerDocument,
        we = n.documentElement || ke.documentElement,
        De = ke.body,
      ...
      return (
        ...
        (xe = {
          ...
          setHandle: function (e, t, a) {
            if (((e = +e), !(0 <= e && e < Ue.length)))
              throw new Error(
                "noUiSlider (14.2.0): invalid handle number, got: " + e
              );
            ie(e, le(t, e), !0, !0), K("update", e), a && K("set", e);
          },
          reset: function (e) {
            de(n.start, e);
          },
    ...
    (L.prototype.getMargin = function (e) {
      ...
      if (t && 0 != (e / t) % 1)
        throw new Error(
          "noUiSlider (14.2.0): 'limit', 'margin' and 'padding' must be divisible by step."
        );
      ...
      (L.prototype.getStep = function (e) {
        return (e = w(this.xPct, this.xSteps, this.snap, e)), e;
      }),
    ...
    return {
      ...
      create: function (e, t) {
        if (!e || !e.nodeName)
          throw new Error(
            "noUiSlider (14.2.0): create requires a single element, got: " + e
          );
        if (e.noUiSlider)
          throw new Error(
            "noUiSlider (14.2.0): Slider was already initialized."
          );
        var a = te(t),
          s = ae(e, a, t);
...
(function () {
  ...
  r.map(function (e) {
    ...
    var a = new CountUp(e, +e.innerText, t);
    return a.error && console.error("CountUp: " + a.error), a.start();
  });
})();
